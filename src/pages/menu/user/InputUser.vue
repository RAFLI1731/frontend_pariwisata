    ...
    <div class="bg-grey-11">
        <div class="row">
            <div class="col-md-6 col-xs-6">
                <q-btn icon="folder" disable color="black" label="Tambah User" no-caps flat></q-btn>
            </div>
        ...
        <div class="row" style="height: 90vh">
            ...
            <q-card flat bordered>
                <div class="q-pb-sm q-pt-md q-pl-md bg-grey-3">
                    <p style="font-size: 20px; font-weight: 500; color: blue;">Informasi User</p>
                </div>
                <q-card-section>
                <q-form
                    @submit="onSubmit"
                    ...
                    <q-input outlined label="Nama User" v-model="nama_user"
                    :rules="[ val => val && val.length > 0 || 'Lengkapi nama user']"
                    >
                    </q-input>
                    <q-input outlined label="Email" v-model="email"
                    :rules="[ val => val && val.length > 0 || 'Lengkapi email']"
                    >
                    </q-input>
                    <q-input 
                    outlined 
    ...
    onSubmit () {
      ...
      this.$api.post('user/register', {
        ...
        if (res.data.code === 200) {
          ...
          console.log('gagal')
          this.$showNotif('Username Telah Ada', 'negative')
