        ...
        <div class="row" style="height: 90vh">
            ...
            <q-card flat bordered>
                ...
                <q-form
                    ...
                    <q-input outlined label="Nama Headline" v-model="form.nama_headline"
                    ...
                    :rules="[ val => val && val.length > 0 || 'Lengkapi isi headline']"
                    >
                    </q-input>
...
export default {
  ...
  methods: {
    getData () {
      this.$api.get(`headline/getbyid/${this.$route.params.id}`)
        .then(res => {
            console.log(res)
    ...
    onSubmit () {
      ...
      this.$api.put(`headline/edit/${this.$route.params.id}`, formData)
        .then(res => {
          if (res.data.sukses) {
