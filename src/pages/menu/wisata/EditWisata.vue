        ...
        <div class="row" style="height: 90vh">
            ...
            <q-card flat bordered>
                ...
                <q-form
                    ...
                    <q-input outlined label="Nama Wisata" v-model="form.nama_wisata"
...
export default {
  ...
  methods: {
    getData () {
      this.$api.get(`wisata/getbyid/${this.$route.params.id}`)
        .then(res => {
            console.log(res)
    ...
    onSubmit () {
      ...
      this.$api.put(`wisata/edit/${this.$route.params.id}`, formData)
        .then(res => {
          if (res.data.sukses) {
