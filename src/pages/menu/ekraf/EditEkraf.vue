        ...
        <div class="row" style="height: 90vh">
            ...
            <q-card flat bordered>
                ...
                <q-form
                    ...
                    <q-input outlined label="Nama Ekonomi Kreatif" v-model="form.nama_ekraf"
                    ...
                    <q-select outlined v-model="form.jenis" :options="options" label="Jenis Ekonomi Kreatif" />
                    <q-file
                        accept=".jpg, image/*"
                        outlined
                        v-model="image"
                        label="Gambar Ekonomi Kreatif"
                    >
...
export default {
  ...
  methods: {
    getData () {
      this.$api.get(`ekraf/getbyid/${this.$route.params.id}`)
        .then(res => {
            console.log(res)
    ...
    onSubmit () {
      ...
      this.$api.put(`ekraf/edit/${this.$route.params.id}`, formData)
        .then(res => {
          if (res.data.sukses) {
