    ...
    <div class="bg-grey-11">
        <div class="row">
            <div class="col-md-6 col-xs-6">
                <q-btn icon="folder" disable color="black" label="Tambah Hotel" no-caps flat></q-btn>
            </div>
        ...
        <div class="row" style="height: 90vh">
            ...
            <q-card flat bordered>
                ...
                <q-form
                    ...
                    <q-input outlined label="Nama Hotel" v-model="nama_hotel"
...
export default {
  ...
  methods: {
    onSubmit () {
      ...
      this.$api.post('hotel/tambah', formData).then(res => {
