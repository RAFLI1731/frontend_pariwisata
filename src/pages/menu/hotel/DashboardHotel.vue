        ...
        <div class="bg">
            <div class="q-pa-md">
                <div class="row">
                    ...
                    <p class="font">Akomodasi Hotel</p>
                </div>
                ...
                <div class="full-width bg-grey-8 q-pa-sm text-center text-white" style="border-radius: 10px 10px 10px 10px;">
                    <p class="font q-mt-sm">Dashboard / Akomodasi Hotel</p>
                </div>
            </div>
        </div>
        <div>
            <q-card class="q-ma-xl bordered" style="margin-top: -80px">
                <div class="row bg-grey-11" style="max-height: auto;">
                    <div class="col-md-6 col-xs-6 text-blue-14 q-pl-lg q-pt-sm"><p style="font-weight: 400; font-size: 20px;">Daftar Hotel</p></div>
                    <div class="col-md-6 col-xs-6">
                        <div v-if="$q.screen.sm || $q.screen.xs">
                            <div class="text-right q-pa-xs">
                                <q-btn icon="add" color="primary" :to="{ name: 'inputHotel' }" no-caps></q-btn>
                            </div>
                        </div>
                        <div v-if="$q.screen.lg || $q.screen.xl || $q.screen.md" class="text-right">
                            <div class="text-right q-pa-xs">
                                <q-btn label="Tambah Data" color="primary" :to="{ name: 'inputHotel' }" no-caps></q-btn>
                            </div>
                        </div>
                    </div>          
                </div>
                ...
                >
                    ...
                    <q-tr>
                        ...
                        <q-td key="nama_hotel" class="text-center tabelSpaceJudul">
                        {{ props.row.nama_hotel }}
                        </q-td>
...
const columns = [
  ...
  { name: 'nama_hotel', align: 'Left', label: 'Nama Hotel', field: 'nama' },
  { name: 'deskripsi', align: 'Left', label: 'Deskripsi', field: 'deskripsi' },
  { name: 'jenis', align: 'Left', label: 'Jenis Hotel', field: 'jenis' },
  ...
  methods: {
    ...
    deleteMovie (id) {
      this.$q.dialog({
        ...
        this.$api.delete(`hotel/delete/${id}`)
          .then(res => {
            if (res.data.sukses) {
