        ...
        <div class="row" style="height: 90vh">
            ...
            <q-card flat bordered>
                ...
                <q-form
                    ...
                    <q-input outlined label="Nama Amenitas" v-model="form.nama_amenitas"
                    ...
                    <q-select outlined v-model="form.jenis" :options="options" label="Jenis Amenitas" />
                    <q-file
                        accept=".jpg, image/*"
                        outlined
                        v-model="image"
...
export default {
  ...
  methods: {
    getData () {
      this.$api.get(`amenitas/getbyid/${this.$route.params.id}`)
        .then(res => {
            console.log(res)
    ...
    onSubmit () {
      ...
      this.$api.put(`amenitas/edit/${this.$route.params.id}`, formData)
        .then(res => {
          if (res.data.sukses) {
